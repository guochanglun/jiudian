   ...
   <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" class="rtable">
	  <tbody>
	     <tr class="tr1">
			...
			<td class="rltitle daslist">&nbsp;&nbsp;&nbsp;&nbsp;×¢²áÓÃ»§µÇÂ¼</td> 
         </tr>
	     <tr class="tr1">
			<td class="rldatee daslist">µÇÂ¼ÕÊºÅ£º</td><input type=hidden name=method value="mlogin"/><input type=hidden name=sf value="×¢²áÓÃ»§"/>
            <td class="rltitle dotlist"><input type="text" size="30" name="username" required /></td> 
         </tr> 
         <tr class="tr1">
			<td class="rldatee daslist">µÇÂ¼ÃÜÂë£º</td>
            <td class="rltitle dotlist"><input type="password" size="30" name="password" required /></td> 
         </tr> 
         <tr class="tr1">
            <td class="rldatee daslist"></td>
			<td class="rltitle daslist"><input type="submit" value="ÓÃ»§µÇÂ¼" style="width:80px;" />
			<input type="button" value="ÓÃ»§×¢²á" style="width:80px;" onclick="reg()"/>
			<input type="button" value="ÕÒ»ØÃÜÂë" style="width:80px;" onclick="lost()"/></td> 
         </tr>
         <tr class="tr1">
            <td class="rldatee daslist"></td>
