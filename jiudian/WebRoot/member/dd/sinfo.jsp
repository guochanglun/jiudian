...
<div class="title_right"><strong>酒店预定管理</strong></div>  
...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap"><strong>到店时间</strong></td> 
...
<%	String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from dd where ddh like '%"+word+"%' and member='"+member+"' order by id desc",14);
