...
<%String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from rz where mc like '%"+word+"%' and tfsj='暂无' order by id desc",13);
...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap">
         <a href="<%=basePath%>admin/rz/add.jsp?method=uprz&id=<%=pagelist2.get(0).toString()%>">修改</a> 
