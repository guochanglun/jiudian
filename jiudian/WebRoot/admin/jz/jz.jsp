...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String ts=""; 
		if(method.equals("upjz")){ 
			ts = cb.getString("select ts from rz where id='"+id+"'"); 
		}	  
%>
<body>
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">入住天数：</td>
     <td><input type="number" name="ts" min="1" class="span3" value="<%=ts %>" required/></td> 
     </tr>  
     <tr>
