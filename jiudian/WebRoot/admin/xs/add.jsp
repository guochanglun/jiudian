...
String message = (String)request.getAttribute("message");
	...
	if(admin==null){
		...
		String id="";String mc=""; String jg=""; String pic=""; 
		if(method.equals("upxs")){
			id=request.getParameter("id");
			List jlist = cb.get1Com("select * from xs where id='"+id+"'",4);
			mc=jlist.get(1).toString();
			jg=jlist.get(2).toString(); 
			pic=jlist.get(3).toString();  
		}	  
%>
<body>
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">餐饮名称：</td>
     <td><input type="text" name="mc" class="span4" value="<%=mc %>" required/></td> 
     </tr> 
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">餐饮价格：</td>
     <td><input type="number" name="jg" min="1" class="span2" value="<%=jg %>" required/> 元</td> 
     </tr> 
     
     <%if(method.equals("upxs")){ %> 
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">餐饮图片：</td>
