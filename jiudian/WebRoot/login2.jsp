   ...
   <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" class="rtable">
	  <tbody>
	     <tr class="tr1">
			...
			<td class="rltitle daslist">&nbsp;&nbsp;&nbsp;&nbsp;Ô±¹¤ÓÃ»§µÇÂ¼</td> 
         </tr>
	     <tr class="tr1">
			<td class="rldatee daslist">µÇÂ¼ÕÊºÅ£º</td><input type=hidden name=method value="one"/> 
         ...
         <tr class="tr1">
            <td class="rldatee daslist"></td>
			<td class="rltitle daslist"><input type="submit" value="ÓÃ»§µÇÂ¼" style="width:80px;" /></td> 
         </tr> 
         <tr class="tr1">
            <td class="rldatee daslist"></td>
